...
namespace PE26A_FSA_
{
  ...
  **************************************************************************/
        ...
        //---------------------------------------------------------------------
        //Función que determina de qué forma se generará el array
        //---------------------------------------------------------------------
        ...
        //---------------------------------------------------------------------
        // Función que resetea el estado del programa
        //---------------------------------------------------------------------
        ...
        //---------------------------------------------------------------------
        // Función que maneja el evento paint del panel y ejecuta el dibujado constantemente
        //---------------------------------------------------------------------
        ...
        //---------------------------------------------------------------------
        // Boton que modifica la velocidad del tick del timer
        //---------------------------------------------------------------------
        ...
        //---------------------------------------------------------------------
        // Boton que hace que el tick sea muy breve, por lo que el ordenamiento se ejecuta muy rápido
        //---------------------------------------------------------------------
        ...
        //---------------------------------------------------------------------
        // Función que ejecuta el algoritmo seleccionado según el tick que reciba actualmente
        //---------------------------------------------------------------------
        ...
        //---------------------------------------------------------------------
        // Botón que regenera el array cuando se selecciona uno distinto
        //---------------------------------------------------------------------
        ...
        //---------------------------------------------------------------------
        // Boton que cambia el algoritmo actual si se selecciona uno distinto
        //---------------------------------------------------------------------
...
**************************************************************************/
        ...
        //---------------------------------------------------------------------
        // Función que localiza casillas con comida
        //---------------------------------------------------------------------
        ...
        //---------------------------------------------------------------------
        // Actualiza la simulación cada tick
        //---------------------------------------------------------------------
        ...
        //---------------------------------------------------------------------
        // Evento paint que redibuja la simulación cada que sea necesario
        //---------------------------------------------------------------------
        ...
        //---------------------------------------------------------------------
        // Función de dibujado de la simulación
        //---------------------------------------------------------------------
        ...
        //---------------------------------------------------------------------
        // Función que actualiza el estado de la simulación
        //---------------------------------------------------------------------
        ...
        //---------------------------------------------------------------------
        // Función que actualiza los labels de información
        //---------------------------------------------------------------------
        void UpdateLabels()
        {
            LblPopulation.Text =
    ...
    "Rojas: " + redPopulation;
        ...
        //---------------------------------------------------------------------
        //Función que dibuja la gráfica de datos
        //---------------------------------------------------------------------
        ...
        //---------------------------------------------------------------------
        // Función que dibuja las lineas de el crecimiento de cada especie
        //---------------------------------------------------------------------
        ...
        //---------------------------------------------------------------------
        // Función paint del panel de la gráfica que la redibuja cad que sea nedcesario
        //---------------------------------------------------------------------
        ...
        //---------------------------------------------------------------------
        // Botón que inicia y pausa la simulación
        //---------------------------------------------------------------------
        ...
        //---------------------------------------------------------------------
        // Función que ejecuta el reinicio de simulación
        //---------------------------------------------------------------------
