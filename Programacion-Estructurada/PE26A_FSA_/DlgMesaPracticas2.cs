...
namespace PE26A_FSA_
{
    ...
    public partial class DlgMesaPracticas2 : Form
    {
        ...
        //---------------------------------------------------------------------
        // Obtiene la palabra capturada por el usuario y encuentra sus letras
        //---------------------------------------------------------------------
        ...
        //---------------------------------------------------------------------
        // Evento que detecta y almacena las coordenadas del centro de las celdas amarillas.
        //---------------------------------------------------------------------
        ...
        //---------------------------------------------------------------------
        // Traza las lineas entre las coordenadas de las letras que contiene la palabra 
        //---------------------------------------------------------------------
        ...
        //---------------------------------------------------------------------
        // Genera lineas desde la posición actual del mouse hasta una coordenada aleatoria
        //---------------------------------------------------------------------
